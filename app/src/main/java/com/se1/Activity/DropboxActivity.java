...
import com.se1.DropBox.ListDropboxFiles;
...
public class DropboxActivity extends Activity implements OnClickListener {
    ...
    private final static String ACCESS_KEY = "oujw7a401lgnthn";
    private final static String ACCESS_SECRET = "55u78g0394dnh40";
